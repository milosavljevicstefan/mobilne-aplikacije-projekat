...
let currentPlayer = aime; // You can set the initial turn to 'playerA'

// Function to change the turn and notify clients
function changeTurn() {
  // Toggle the turn between playerA and playerB
  currentPlayer = currentPlayer === aime ? bime : aime;

  // Emit an event to inform clients about the new turn
